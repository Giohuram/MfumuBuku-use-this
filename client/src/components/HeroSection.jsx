    ...
    <div className="bg-[#DC7211] py-16 px-4 md:px-0">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Un enfant qui lit sera un adulte qui réflechit!</h1>
          ...
          <Link to="/signup">
           <button className="bg-black text-white font-semibold py-2 px-4 rounded-full hover:bg-black hover:text-white transition duration-300">J'inscris mon enfant</button>
          </Link> 
        </div>
        {/* Image */}
